...
//		iBottom = de.clientHeight - D;
		var _c = $("#resumeCanvas")
		var _r = _c.offset().left + _c.width()
		var _b = _c.offset().top + _c.height()
		iRight =  _r - D;
		iBottom = _b - D;
	}
	...
	function checkWalls(bub)
	{
		...
		if(bub.x < _c.offset().left)
		{
			bub.setX(_c.offset().left);
			bub.vx *= -1;
		}
		...
		if(bub.y < _c.offset().top)
		{
			bub.setY(_c.offset().top);
			bub.vy *= -1;
		}
